...
<html lang="en">
    ...
    <body class="auth-body-bg">
                                        ...
                                        <div>
                                            ...
                                            <div class="errormessage"></div>
                                                    ...
                                                    <div class="form-group auth-form-group-custom mb-4">
                                                        ...
                                                        <input type="password" class="form-control" required="" data-parsley-equalto="#password" id="passconf" name="passconf" placeholder="Re-Type Password" autocomplete="off">
        ...
        <?php $this->forminput->formpost('form_post',"loadingdiv",base_url('user/images/loading2.gif'),"submitbtn1","form_acction", 'students/recover_data' ,'Login Successfully'  ); ?>
