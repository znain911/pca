                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="media">
                                                    <div class="media-body overflow-hidden">
                                                    	<?php 
                                                    	$examcount = count($this->students_m->getExamStd($metadata['id'],$examinfo->exam_id));
                                                    	$eleft = 3 - $examcount;
                                                    	if ($examinfo->result == 'Fail') {
                                                    		echo '<h2>You have failed to achieve 50% required to pass the exam. You have '.$eleft.' attempts remaining</h2>';
                                                    	}else{
                                                    		echo '<h2>You have successfully passed the PCA-3 Exam. Please wait for DLP Authority to publish the result.</h2>';
                                                    	}
