            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <!-- end page title -->
                        <?php if($examinfo->qtype == 1){
                                $nofq = $examinfo->no_of_question_theory;
                                $ttlmark = $examinfo->total_mark_theory;
                                $pssmark = $examinfo->pass_mark_theory;
                                $ehead = 'Theory';
                            }elseif($examinfo->qtype == 2){
                                $nofq = $examinfo->no_of_question_osce;
                                $ttlmark = $examinfo->total_mark_osce;
                                $pssmark = $examinfo->pass_mark_osce;
                                $ehead = 'OSCE';
                            }elseif($examinfo->qtype == 3){
                                $nofq = $examinfo->no_of_question_ospe;
                                $ttlmark = $examinfo->total_mark_ospe;
                                $pssmark = $examinfo->pass_mark_ospe;
                                $ehead = 'OSPE';
                            }
                            ?>
                        <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card border border-primary">
                                            <div class="card-body border-bottom py-3">
                                                <h6 class="my-0 text-info float-left">Exam Name: <?php echo $examinfo->schedule_name.' - '.$ehead;?></h6>
                                                <!-- <div id="countdown"></div> -->
                                                <h6 class="my-0 text-info float-right">Total Marks: <?php echo $ttlmark;?></h6>
                                            </div>
                                            <div class="card-body">
                                                       ...
                                                       <div class="table-responsive">
                                                        <table class="table mb-0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $nofq;?></td>
                                                                    <td><?php echo $ttlmark;?></td>
                                                                    <td><?php echo $pssmark;?></td>
