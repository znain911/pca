...
<html lang="en" dir="ltr">
	...
	<body class="app sidebar-mini rtl">
							...
							<div class="col-md-12">
								...
								<div class="card">
									...
									<div class="card-header">
										...
										<a href="javascript:void(0)" class="btn btn-primary float-right">Edit</a>
									</div>
											...
											<div>
												...
												<div id="step-12" class="">
													<?php $attributes = array('id' => 'form_post3', 'name'=>'form_post3', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data' );echo form_open('javascript:void(0)',$attributes);?>
														...
														<input type="hidden" class="form-control" id="pcode3" name="pcode2" value="<?php echo $patientinfo->patient_code;?>" autocomplete="off" readonly >
														<?php $this->load->view('prescriptions/prescriptionform3');?>
														<?php echo form_close(); ?> 
													<?php $this->forminput->formpost('form_post3',"loadingdiv",base_url('user/images/loading2.gif'),"submitbtn3","form_acction", $save_v1 ,'Added Successfully'  ); ?>
		...
		function form_acction(msg){
			...
			if(msg=='Added Successfully'+idr){									
				/*var jmpurl='<?php echo base_url('auth');?>';
				window.location=jmpurl;	*/
				$("#form_post")[0].reset();
				$('#age').val(idr);
			}
