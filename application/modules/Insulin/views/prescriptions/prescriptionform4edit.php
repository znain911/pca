...
<div class="row border">
	<div class="col">
		<div class="form-group">
			...
			<input name="vdate2" id="vdate2" placeholder="Select Date" autocomplete="off" class="form-control fc-datepicker"/>
			
		</div>
		<div class="form-group">
			<label class="form-label" for="doctorid_v">Visiting Doctor: </label>
			<select id="doctorid_v" name="doctorid_v"  class="form-control select2-show-search" style="width: 100%">
