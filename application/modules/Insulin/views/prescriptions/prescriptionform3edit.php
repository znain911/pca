	...
	<div class="col-lg-6 col-sm-12 border"> <!-- CURRENT TREATMENT -->
		...
		<div class="form-group">
			...
			<div class="row gutters-xs">
				<div class="col">
					<label>Insulin</label>
					<select  name="cur_insln" id="cur_insln" class="form-control select2-show-search">
						<option value="">--Select Insulin--</option>
						<?php foreach ($insulinlist as $insln1) {?>
							<option value="<?php echo $insln1->insulin_id; ?>"><?php echo $insln1->insulin_name; ?></option>
						<?php } ?>
				...
				<span class="col-auto">
					...
					<br/>
					<label></label>
					<button class="btn btn-primary" type="button" id="add_insulincr"><i class="fa fa-plus-square"></i></button>
				</span>
			</div>
			<div class="row">
				<table class="table table-striped responsive-table">

                  <tbody id="insulin_tablecur">
                  </tbody>
                </table>
			</div>
