                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            echo $newTime1.'-sep-'.$lst->login_datetime.'-c-'.date("Y-m-d H:i:s");
                                                             ?>
                                                        </td>
                                                        <td>                  
                                                         <?php
                                                            $cdt = date("Y-m-d H:i:s");
                                                            $seconds = strtotime($cdt) - strtotime($lst->login_datetime);
                                                            ...
                                                            if ($ttlmnt < 5) {
																echo '<span style="color:green">Available</span>'.$cdt;
															}else{
																echo '<span style="color:red">Time over</span>'.$cdt;
															}
                                                         ?>
                                                        </td>
