...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>V1 vs V2 Report – Changing Diabetes Barometer (CDB)</title>
				...
				<div class="container-fluid content-area">
					<div class="side-app">
						...
						<div class="page-header">
							...
							<form action="<?= site_url('reports/v1vsv2report')?>" method="post" class="row">
								<div class="col">
						...
						<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Visit 1 vs Visit 2 Report</div>
								</div>
								<div class="card-body">
                                	<style type="text/css">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<thead class="bg-blue text-white">
							...
							<tr class="main">
								...
								<th class="col col5">Count of Recruitment</th>
								<!-- <th class="col col6">Visit 1 HbA1c (Paid)</th>
								<th class="col col7">Visit 1 HbA1c (Free)</th> -->
								<th class="col col8">Coutn of Follow-Up</th>
