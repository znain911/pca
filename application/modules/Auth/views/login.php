...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Login - Changing Diabetes Barometer (CDB)</title>
	...
	<body class="bg-account">
		...
		<!-- page End-->
<?php $this->forminput->formpost('form_post',"loadingdiv",base_url('user/images/loading2.gif'),"submitbtn1","form_acction", 'auth/verifylogin' ,'Login Successfully'  ); ?>
