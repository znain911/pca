...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Patients – Changing Diabetes Barometer (CDB)</title>
					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<div class="ml-auto">
									...
									<!-- <a class="btn btn-success" href="<?php echo base_url('setup/addprofession');?>" ><i class="fe fe-plus mr-1 mt-1"></i> Add New</a> -->
							</div>
						</div>
						<!-- End page-header -->
										...
										<table id="example" class="table table-striped table-bordered w-100">
											<thead class="bg-blue text-white">
												<tr>
													...
													<th>Name</th>
													<th>Phone</th>
													<th class="text-center">At Time of Diagnosis</th>
													<th class="text-center">5 Years after Diagnosis</th>
													<th class="text-center">Recruitment</th>
											...
											<?php if(!empty($patients)){ foreach($patients as $patient):?>
												<tr>
													...
													<td><?= $patient['created_datetime']?></td>
													<td><?= $patient['patient_name']?></td>
													<td><?= $patient['phone']?></td>
													<td class="text-center"><?php if($patient['first']=='1'){?><i class="fa fa-check"></i><?php }else{?><i class="fa fa-times"></i><?php }?></td>
													<td class="text-center"><?php if($patient['five']=='1'){?><i class="fa fa-check"></i><?php }else{?><i class="fa fa-times"></i><?php }?></td>
													<td class="text-center"><?php if($patient['first1']=='1'){?><i class="fa fa-check"></i><?php }else{?><i class="fa fa-times"></i><?php }?></td>
													<td class="text-center"><?php if($patient['follow1']=='1'){?><i class="fa fa-check"></i><?php }else{?><i class="fa fa-times"></i><?php }?></td>
													<td class="text-center action-link">
														<?php if($patient['first1']=='1'){?><a href="<?= site_url('patient/prescriptions/'.$patient['id'])?>#step-13" >View</a><?php }else{?><a href="<?= site_url('patient/prescriptions/'.$patient['id'])?>" >View</a><?php }?>
														
														<!-- <a href="<?= site_url('patient/prescriptions/'.$patient['id'].'/history')?>" >View</a> -->
