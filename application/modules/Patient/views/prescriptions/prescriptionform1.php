		...
		<div class="form-group">
			...
			<div class="row gutters-xs">
				...
				<div class="col-8">
					...
					<button type="button" name="add_ogld1" id="add_ogld1" class="btn btn-success" data-visit="1" title="Add another OGLD" style="float: left;width: 10%;">+</button>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col">
				<div class="form-group">
					...
					<select  name="insulintype1" id="insulintype1" class="form-control">
