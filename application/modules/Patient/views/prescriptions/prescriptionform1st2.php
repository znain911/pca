	...
	<div class="col-lg-6 col-sm-6 border"> <!-- clinical -->
		...
		<div class="row">
			<div class="col">
				<div class="form-group">
					<label>Height</label>
					<input type="text" class="form-control" data-visit="3" name="atd_height" id="atd_height" placeholder="CM">
					<div class="form-error" id="error-atd_height"></div>
				</div>
				<div class="form-group">
					<label>Waist</label>
					<input type="text" class="form-control" data-visit="3" name="atd_waist" id="atd_waist" placeholder="CM">
			...
			<div class="col">
				<div class="form-group">
					<label>Weight</label>
					<input type="text" class="form-control" data-visit="3" name="atd_weight" id="atd_weight" placeholder="KG">
				</div>
				<div class="form-group">
					<label>Hip</label>
			...
			<div class="col">
				<div class="form-group">
					<label>BMI</label>
					<input type="text" class="form-control" name="atd_bmi" id="atd_bmi" placeholder="kg/m2">
				</div>
				<div class="form-group">
					<label>Waist-hip-ratio</label>
					<input type="text" class="form-control" name="atd_waist_hip_ratio" id="atd_waist_hip_ratio" placeholder="">
				</div>
