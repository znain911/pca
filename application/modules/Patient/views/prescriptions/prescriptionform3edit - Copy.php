	...
	<div class="col-lg-6 col-sm-12 border"> <!-- PREVIOUS TREATMENT -->
			...
			<div class="row gutters-xs">
				...
				<div class="col-4">
					<div class="form-group">
						...
						<input type="text" name="prev_ogld[]" id="prev_ogldname13" data-visit="3"  placeholder="OGLD" value="<?php echo $preinl->brand;?>" autocomplete="off" class="form-control" />
					</div>
				</div>
				<div class="col-8">
		...
		<div class="form-group">
			...
			<?php
				...
				<div class="col-4">
					<div class="form-group">
						<input type="text" name="prev_basal3[]" id="prev_basal3" data-visit="3"  placeholder="Insulin" value="<?php echo $inslnpre->insulin_name; ?>" autocomplete="off" class="form-control" />
					</div>
				</div>
				<div class="col-8">
			...
			<div class="row gutters-xs">
				...
				<div class="col-4">
					<div class="form-group">
						...
						<input type="text" name="ogld[]" id="ogldname13" data-visit="3"  placeholder="OGLD" value="<?php echo $ogldcr->brand; ?>" autocomplete="off" class="form-control" />
					</div>
				</div>
				<div class="col-8">
			...
			<div class="row gutters-xs">
				...
				<div class="col-4">
					<div class="form-group">
						...
						<input type="text" name="basal3[]" id="basal3" data-visit="3"  placeholder="Insulin" autocomplete="off" class="form-control" value="<?php echo $insln->insulin_name; ?>" />
					</div>
				</div>
				<div class="col-8">
