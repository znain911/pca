...
<html lang="en" dir="ltr">
	...
	<body class="app sidebar-mini rtl">
										...
										<div class="row">
											...
											<div class="col">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="name" name="name" placeholder="Name" autocomplete="off" value="<?php echo $patientinfo->patient_name; ?>">
												...
												<div class="form-group ">
													...
													<select class="form-control select2" data-placeholder="Choose one" id="division" name="division">
														...
														<?php foreach ($divisionlist as $dvsnlist) {?>
															<option value="<?php echo $dvsnlist->division_id;?>" <?php if($patientinfo->division_id == $dvsnlist->division_id){ echo 'selected'; } ?>><?php echo $dvsnlist->division_name;?></option>													
														<?php } ?>
												...
												<div class="form-group">
													...
													<input type="text" name="phone" id="phone" class="form-control" placeholder="Phone" autocomplete="off" value="<?php echo $patientinfo->phone; ?>">
													<div class="form-error" id="error-phone"></div>
												</div>
												<div class="form-group">
													<label class="form-label"># of children</label>
													<input type="text" class="form-control" name="children" id="children" placeholder="# of children" autocomplete="off" value="<?php echo $patientinfo->number_of_child; ?>">
											...
											<div class="col">
												<div class="form-group">
													...
													<select class="form-control select2" id="gender" name="gender">
														...
														<option value="others" <?php if($patientinfo->gender == 'others'){ echo 'selected'; } ?>>Others</option>
													</select>
												...
												<div class="form-group">
													...
													<select class="form-control select2-show-search" data-placeholder="Choose one" id="district" name="district">
														<option value="<?php echo $patientinfo->district_id;?>"><?php echo $patientinfo->district_name;?></option>
													</select>
													<div class="form-error" id="error-district"></div>
												</div>
												<div class="form-group">
													<label class="form-label">Email</label>
													<input type="text" class="form-control" name="email" id="email" placeholder="Email" autocomplete="off" value="<?php echo $patientinfo->email;?>">
													<div class="form-error" id="error-email"></div>
												</div>
												<div class="form-group">
													<label class="form-label">Patient Book No</label>
													<input type="text" class="form-control" name="book_no" id="book_no" placeholder="Patient Book No" autocomplete="off" value="<?php echo $patientinfo->patient_book_number;?>">
												</div>
											...
											<div class="col">
												<div class="form-group">
													...
													<input name="dob" id="dob" placeholder="Select Date" autocomplete="off" class="form-control fc-datepicker" value="<?php echo date("Y-m-d", strtotime($patientinfo->dob)); ?>" />
													
												</div>							
												
												<div class="form-group">
													<label class="form-label" for="thana">Thana:</label>
													<input type="text" name="thana" id="thana" class="form-control" value="<?php echo $patientinfo->thana;?>">
												</div>	
												...
												<div class="form-group">
													...
													<select id="expenditure" name="expenditure" class="form-control">
														...
														<?php foreach ($explist as $exlist) {?>
															<option value="<?php echo $exlist->expenditure_name;?>" <?php if ($patientinfo->expenditure==$exlist->expenditure_name) { echo 'selected';} ?>><?php echo $exlist->expenditure_name;?></option>
														<?php }?>
												...
												<div class="form-group">
													...
													<input type="text" name="nid" id="nid" placeholder="NID" class="form-control" value="<?php echo $patientinfo->nid;?>">
												</div>
											</div>
											...
											<div class="col">
												<div class="form-group">
													...
													<input type="text" name="age" id="age" class="form-control" value="<?php echo $patientinfo->age;?>">
													<div class="form-error" id="error-age"></div>
												</div>							
												<div class="form-group">
													<label class="form-label" for="address">Full Address</label>
													
													<textarea class="form-control" name="address" id="address" rows="4" placeholder="Full Address"><?php echo $patientinfo->address;?></textarea>
												</div>
												...
												<div class="form-group">
													...
													<select id="profession" name="profession" class="form-control">
														...
														<?php foreach ($profesionlist as $plist) {?>
															<option value="<?php echo $plist->profession_name;?>" <?php if ($patientinfo->profession==$plist->profession_name) { echo 'selected'; } ?>><?php echo $plist->profession_name;?></option>
														<?php }?>
											...
											<div class="col">
												<div class="form-group">
													...
													<select id="type_of_diabetes" name="type_of_diabetes" class="form-control">
														...
														<?php foreach ($diabetestypelist as $dtype) {?>
															<option value="<?php echo $dtype->type_name;?>" <?php if ($dtype->type_name==$patientinfo->type_of_diabetes) { echo 'selected';} ?>><?php echo $dtype->type_name;?></option>
														<?php }?>
												...
												<div class="form-group">
													...
													<select id="dm_status" name="dm_status" class="form-control">
														...
														<?php foreach ($dmstatuslist as $dmdlist) {?>
															<option value="<?php echo $dmdlist->duration_name;?>" <?php if ($dmdlist->duration_name==$patientinfo->dm_duration) {echo 'selected';}?>><?php echo $dmdlist->duration_name;?></option>
														<?php }?>
												...
												<div class="form-group">
													...
													<input type="radio" name="familyhistry" value="yes" <?php if ($patientinfo->family_history=='yes') {echo 'checked';} ?>> Yes
													<input type="radio" name="familyhistry" value="no" <?php if ($patientinfo->family_history=='no') {echo 'checked';} ?>> No
												</div>
												<div class="form-group">
													<label class="form-label" for="smoking">Smoking: </label>
													<input type="radio" name="smoking" value="yes" <?php if ($patientinfo->smoking=='yes') {echo 'checked';} ?>> Yes
													<input type="radio" name="smoking" value="no" <?php if ($patientinfo->smoking=='no') {echo 'checked';} ?>> No
												</div>
											</div>
		...
		<?php $this->forminput->formpost('form_post',"loadingdiv",base_url('user/images/loading2.gif'),"submitbtn1","form_acction", $editpatient_database ,'Update Successfully'  ); ?>
		<script type="text/javascript">
		function form_acction(msg){
			if(msg=='Update Successfully'){									
				var jmpurl='<?php echo site_url('patient/prescriptions/').$patientinfo->id;?>';
