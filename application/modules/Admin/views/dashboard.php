                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <!-- <div class="col-xl-8">
                                ...
                                <!-- end row -->
                               <!-- <h4 class="card-title mb-4">Latest Students</h4>

                                        <div class="table-responsive">
                                            <table id="example" class="table table-centered dt-responsive" data-page-length="5" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);" class="mr-3 text-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="mdi mdi-eye font-size-18"></i></a>
