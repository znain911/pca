...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Reset Students | Distance Learning Programme (DLP)</title>
    ...
    <body data-sidebar="dark">
                                        ...
                                        <?php $attributes = array('id' => 'form_post', 'name'=>'form_post', 'class' => 'custom-validation', 'style'=>'position:relative;', 'enctype'=>'multipart/form-data');echo form_open('javascript:void(0)',$attributes);?>
                                            <div class="errormessage"></div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input type="password" name="stpassword" id="stpassword" class="form-control" placeholder="Password" />
                                                            <div class="form-error" id="error-stpassword"></div>
                                                        </div>
                                                    </div>
                                                   <div class="form-group">
                                                        <label>Status</label>
                                                        <div>
                                                            <select class="form-control" name="publish" id="publish" required>
                                                                <option value="1" <?php if($st_data->st_status == 1){ echo 'selected'; } ?>>Active</option>
                                                                <option value="0" <?php if($st_data->st_status == 0){ echo 'selected'; } ?>>Inactive</option>
                                                            </select>
                                                        </div>
                                                    </div>
       ...
       <?php $this->forminput->formpost('form_post',"loadingdiv",base_url('user/images/loading2.gif'),"submitbtn1","form_acction", 'admin/resetstudent_data/'.$stid ,'Update Successfully'  ); ?>
