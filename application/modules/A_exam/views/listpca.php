                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">PCA Exam Schedule</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url('admin');?>">Dashboard</a></li>
                                            <li class="breadcrumb-item active">PCA Exam Schedule</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div>
                                            <a href="<?php echo base_url('a_exam/addpcaexam');?>" class="btn btn-success mb-2"><i class="mdi mdi-plus mr-2"></i> Add PCA Exam Schedule</a>
                                        </div>
                                            ...
                                            <table id="example" class="table table-centered dt-responsive" data-page-length="10" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $lst->marks_per_question_osce; ?></td>
...
<a href="<?php echo base_url('a_exam/editpcaexam_schedule/').$lst->schedule_id; ?>" class="mr-3 text-info" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class=" ri-edit-box-fill font-size-18"></i></a>
                                                            <?php } ?>
