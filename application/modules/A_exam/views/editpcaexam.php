...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Edit PCA Exam Schedule | Distance Learning Programme (DLP)</title>
    ...
    <body data-sidebar="dark">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Edit PCA Exam Schedule</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url('a_exam/pcaexam');?>">PCA Exam Schedule</a></li>
                                            <li class="breadcrumb-item active">Edit PCA Exam Schedule</li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <?php $attributes = array('id' => 'form_post', 'name'=>'form_post', 'class' => 'custom-validation', 'style'=>'position:relative;', 'enctype'=>'multipart/form-data');echo form_open('javascript:void(0)',$attributes);?>
                                            <div class="errormessage"></div>
                                                    ...
                                                    <div class="form-group">
                                                        <label>End Date & Time <?php $enddatetm = date('Y-m-d', strtotime($sdl_data->end_date)).'T'.date('H:i:s', strtotime($sdl_data->end_date));?></label>
                                                        <div class="input-group">
       ...
       <?php $this->forminput->formpost('form_post',"loadingdiv",base_url('user/images/loading2.gif'),"submitbtn1","form_acction", 'a_exam/editpcaexam_data/'.$examid ,'Update Successfully'  ); ?>
        <script type="text/javascript">
        function form_acction(msg){ 
            if(msg=='Update Successfully'){                                  
                var jmpurl='<?php echo base_url('a_exam/pcaexam');?>';
