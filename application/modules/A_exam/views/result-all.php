...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Result | Distance Learning Programme (DLP)</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                       <div>
                                            <a href="<?php echo base_url('a_exam/exportresult');?>" class="btn btn-success mb-2"><i class="ri ri-download-cloud-2-line mr-2"></i> Export</a>
                                        </div>
                                            ...
                                            <table id="example" class="table table-centered" data-page-length="10" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $lst->marks_per_question*count($correctans); ?></td> -->
