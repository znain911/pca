...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Add PCA Exam Schedule | Distance Learning Programme (DLP)</title>
    ...
    <body data-sidebar="dark">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Add PCA Exam Schedule</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url('a_exam/pcaexam');?>">PCA Exam Schedule</a></li>
                                            <li class="breadcrumb-item active">Add PCA Exam Schedule</li>
                                        </ol>
                                    </div>
                                        ...
                                        <?php $attributes = array('id' => 'form_post', 'name'=>'form_post', 'class' => 'custom-validation', 'style'=>'position:relative;', 'enctype'=>'multipart/form-data');echo form_open('javascript:void(0)',$attributes);?>
                                            <div class="errormessage"></div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input type="text" name="no_of_question_osce" id="no_of_question_osce" class="form-control" placeholder="Number of Questions"  />
                                                        </div>
                                                        <div class="form-error" id="error-no_of_question_osce"></div>
                                                        </div>
                                                        <div class=" col-xl-3">
                                                        ...
                                                        <div>
                                                            <input type="text" name="marks_per_question_osce" id="marks_per_question_osce" class="form-control" placeholder="Mark per Question"  />
                                                        </div>
                                                        ...
                                                        <div>
                                                            <input type="text" name="total_mark_osce" id="total_mark_osce" class="form-control" placeholder="Total Marks"  />
                                                        </div>
                                                        ...
                                                        <div>
                                                            <input type="text" name="pass_mark_osce" id="pass_mark_osce" class="form-control" placeholder="Pass Marks"  />
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Exam Time (Minute)</label>
                                                        <div>
                                                            <input type="text" name="exam_time_osce" id="exam_time_osce" class="form-control" placeholder="Exam Time"  />
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                        <!--<div class=" col-xl-3">
															<label>Number of Questions TMA 1</label>
															<div>
																<input type="text" name="marks_per_question_m2" id="marks_per_question_m2" class="form-control" placeholder="Total Marks" value="20" readonly />
															</div>
                                                        
                                                        </div>
														
														<div class=" col-xl-3">
															<label>Number of Questions TMA 2</label>
															<div>
																<input type="text" name="marks_per_question_m2" id="marks_per_question_m2" class="form-control" placeholder="Total Marks" value="20" readonly />
															</div>
															...
															<div class=" col-xl-3">
																<label>Number of Questions Module 8</label>
																<div>
																	<input type="text" name="marks_per_question_m3" id="marks_per_question_m3" class="form-control" placeholder="Total Marks" value="5" readonly />
																</div>
															
															</div>
															
															<div class=" col-xl-3">
																<label>Number of Questions Module 9</label>
																<div>
																	<input type="text" name="marks_per_question_m4" id="marks_per_question_m3" class="form-control" placeholder="Total Marks" value="5" readonly />
																</div>
															
															</div>
															
															<div class=" col-xl-3">
																<label>Number of Questions Module 10</label>
																<div>
																	<input type="text" name="marks_per_question_m5" id="marks_per_question_m3" class="form-control" placeholder="Total Marks" value="5" readonly />
																</div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div>
                                                    ...
                                                    <a href="<?php echo base_url('a_exam/pcaexam');?>"  class="btn btn-secondary waves-effect">
                                                        Cancel
                                                    </a>
                                                </div>
                                            </div>
       ...
       <?php $this->forminput->formpost('form_post',"loadingdiv",base_url('user/images/loading2.gif'),"submitbtn1","form_acction", 'a_exam/pcaexam_data' ,'Added Successfully'  ); ?>
        ...
        <script>         
          $(document).ready(function() {
              ...
              $("#no_of_question_osce,#marks_per_question_osce").keyup(function () {
                $('#total_mark_osce').val($('#no_of_question_osce').val() * $('#marks_per_question_osce').val());
            });
