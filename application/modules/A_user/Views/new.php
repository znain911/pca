      ...
      <div class="static-content">
        <div class="page-content">
          <div class="row" style="background: #f5f5f5 none repeat; margin-bottom:20px;">
            ...
            <div class="col-md-5">
              <div style="padding:30px 10px; text-align:right;"> <a class="btn btn-label btn-social btn-github" href="<?php echo base_url($listform);?>"><i class="fa fa-bars"></i><?php echo $metadata['heading'];?> List</a> </div>
            </div>
          </div>
            ...
            <div data-widget-group="group1">
              ...
              <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                <div class="panel-heading">
                  <h2>New <?php echo $metadata['heading'];?></h2>
                </div>
