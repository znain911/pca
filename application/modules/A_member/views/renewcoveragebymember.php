      ...
      <div class="static-content">
        <div class="page-content">
          <div class="row" style="background: #f5f5f5 none repeat; margin-bottom:20px;">
            ...
            <div class="col-md-5">
              <div style="padding:30px 10px; text-align:right;"> <a class="btn btn-label btn-social btn-github" href="<?php echo base_url($optionlistform);?>"><i class="fa fa-bars"></i>Member List</a> </div>
            </div>
          </div>
            ...
            <div data-widget-group="group1">
              ...
              <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                <div class="panel-heading">
                  <h2><?php echo $get_mbrinfo->member_name;?>; ID: <?php echo $get_mbrinfo->employee_id;?>; <?php echo $mbr_billamount->total;?></h2>
                </div>
                ...
                <div class="panel-body">
                  <?php
                   ...
                   array(
                    ...
                    'class' => 'form-control',
                    'autocomplete' => 'off',
                    'value' => isset($get_mbrinfo->employee_id) ? $get_mbrinfo->employee_id : '',   
                  ),

                  array(
                    'id' => 'coverage_name_old',
                    'label' => 'Member Name <span>*</span>',
                    'type' => 'hidden',
                    'placeholder' => '',
                    'class' => 'form-control',
                    'autocomplete' => 'off',
                    'value' => isset($get_mbrinfo->coverage_period) ? $get_mbrinfo->coverage_period : '',   
                  ),
                  ...
                  array(
                    ...
                    'class' => 'form-control',
                    'autocomplete' => 'off',
                    'value' => isset($get_mbrinfo->start_date) ? $get_mbrinfo->start_date : '',   
                  ),
                  ...
                  array(
                    ...
                    'class' => 'form-control',
                    'autocomplete' => 'off',
                    'value' => isset($get_mbrinfo->end_date) ? $get_mbrinfo->end_date : '',   
                  ),
                  array(
                    'id' => 'totalcost',
                    'label' => 'Member Name <span>*</span>',
                    ...
                    'class' => 'form-control',
                    'autocomplete' => 'off',
                    'value' => isset($mbr_billamount->total) ? $mbr_billamount->total : '',   
                  ),
