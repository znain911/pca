...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Add Doctor - Changing Diabetes Barometer (CDB)</title>
				...
				<div class="container content-area">
					<div class="side-app">
						...
						<div class="page-header">
							...
							<div class="ml-auto">
									<a class="btn btn-success" href="<?php echo base_url('setup/doctor');?>" ><i class="fe fe-list mr-1 mt-1"></i> Doctor List</a>
							</div>
						</div>
						<!-- End page-header -->
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Add new Doctor</h3>
