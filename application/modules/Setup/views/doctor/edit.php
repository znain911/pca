...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Edit Doctor - Changing Diabetes Barometer (CDB)</title>
	...
	<body class="app sidebar-mini rtl">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url('setup/doctor');?>">Doctor</a></li>
								<li class="breadcrumb-item active" aria-current="page">Edit Doctor</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/doctor');?>" ><i class="fe fe-list mr-1 mt-1"></i> Doctors List</a>
							</div>
						</div>
						<!-- End page-header -->
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Edit Doctor</h3>
										...
										<div class="row">
											...
											<div class="col">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="inslname" name="inslname" placeholder="Name" autocomplete="off" value="<?php echo $info->doctor_name; ?>">
												...
												<div class="form-group ">
													...
													<select name="status" id="status" class="form-control">
														...
														<option value="0" <?php if($info->is_active==0){echo 'selected'; } ?>>Inactive</option>					
													</select>
		...
		function form_acction(msg){
			if(msg=='Update Successfully'){									
				var jmpurl='<?php echo site_url('setup/doctor/');?>';
