...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Profession – Changing Diabetes Barometer (CDB)</title>
						...
						<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Profession</div>
								</div>
								<div class="card-body">
                                	<div class="table-responsive" id="hba1ctable">
										<table id="example" class="table table-striped table-bordered w-100">
											...
											<tbody>
												<?php foreach($professionlist as $list){?>
												<tr>
													<td><?php echo $list->profession_name;?></td>
													<td><?php if($list->status==1){echo 'Active'; }else{echo 'Inactive';} ?></td>
													<td>
														<a href="<?php echo base_url('setup/editprofession/').$list->id;?>" class="btn btn-app btn-primary btn-sm"><i class="fa fa-edit"></i>Edit</a>
													</td>
												</tr>
												<?php }?>
