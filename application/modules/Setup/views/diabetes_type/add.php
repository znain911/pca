...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Add diabetes type - Changing Diabetes Barometer (CDB)</title>
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url('setup/expenditure');?>">diabetes type</a></li>
								<li class="breadcrumb-item active" aria-current="page">Add diabetes type</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Add new diabetes type</h3>
