...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Edit diabetes type - Changing Diabetes Barometer (CDB)</title>
	...
	<body class="app sidebar-mini rtl">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url('setup/diabetes_type');?>">diabetes type</a></li>
								<li class="breadcrumb-item active" aria-current="page">Edit diabetes type</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/diabetes_type');?>" ><i class="fe fe-list mr-1 mt-1"></i> Diabetes type List</a>
							</div>
						</div>
						<!-- End page-header -->
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Edit Diabetes type</h3>
										...
										<div class="row">
											...
											<div class="col">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="inslname" name="inslname" placeholder="Name" autocomplete="off" value="<?php echo $info->type_name; ?>">
		...
		function form_acction(msg){
			if(msg=='Update Successfully'){									
				var jmpurl='<?php echo base_url('setup/diabetes_type/');?>';
