...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Add District - Changing Diabetes Barometer (CDB)</title>
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Add new District</h3>
												...
												<div class="form-group ">
													...
													<select name="division" id="division" class="form-control">
														...
														<?php foreach ($dvsnlist as $dlist) {?>
															<option value="<?php echo $dlist->division_id;?>"><?php echo $dlist->division_name;?></option>
														<?php }?>					
													</select>
