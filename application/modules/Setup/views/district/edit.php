...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Edit District - Changing Diabetes Barometer (CDB)</title>
	...
	<body class="app sidebar-mini rtl">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url('setup/district');?>">District</a></li>
								<li class="breadcrumb-item active" aria-current="page">Edit District</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/district');?>" ><i class="fe fe-list mr-1 mt-1"></i> District List</a>
							</div>
						</div>
						<!-- End page-header -->
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Edit District</h3>
											...
											<div class="col">
												<div class="form-group ">
													...
													<select name="division" id="division" class="form-control">
														...
														<?php foreach ($dvsnlist as $dlist) {?>
															<option value="<?php echo $dlist->division_id;?>" <?php if($info->division_id==$dlist->division_id){echo 'selected'; } ?> ><?php echo $dlist->division_name;?></option>
														<?php }?>					
													</select>
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="inslname" name="inslname" placeholder="Name" autocomplete="off" value="<?php echo $info->district_name; ?>">
													<div class="form-error" id="error-inslname"></div>

													<input type="hidden" class="form-control" id="inslnid" name="inslnid" placeholder="Name" autocomplete="off" value="<?php echo $info->district_id; ?>">
												</div>
		...
		function form_acction(msg){
			if(msg=='Update Successfully'){									
				var jmpurl='<?php echo base_url('setup/district/');?>';
