	...
	<body class="app sidebar-mini rtl">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url('setup/insulin');?>">Insulin</a></li>
								<li class="breadcrumb-item active" aria-current="page">Edit Insulin</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/insulin');?>" ><i class="fe fe-list mr-1 mt-1"></i> Insulin List</a>
							</div>
						</div>
						<!-- End page-header -->
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Edit Insulin</h3>
										...
										<div class="row">
											...
											<div class="col">
												<div class="form-group">
													<label class="form-label" for="name">Insulin Name</label>
													<input type="text" class="form-control" id="inslname" name="inslname" placeholder="Name" autocomplete="off" value="<?php echo $insulininfo->insulin_name; ?>">
													<div class="form-error" id="error-inslname"></div>

													<input type="hidden" class="form-control" id="inslnid" name="inslnid" placeholder="Name" autocomplete="off" value="<?php echo $insulininfo->insulin_id; ?>">
												</div>
												<div class="form-group ">
													<label class="form-label">Type</label>
													<input type="text" class="form-control" id="type" name="type" placeholder="insulin clinical type" autocomplete="off" value="<?php echo $insulininfo->insulin_clinical_type; ?>">
													<div class="form-error" id="error-type"></div>
												</div>
												<div class="form-group">
													<label for="phone" class="form-label">Class</label>
													<input type="text" name="class" id="class" class="form-control" placeholder="Class" autocomplete="off" value="<?php echo $insulininfo->insulin_class; ?>">
													<div class="form-error" id="error-class"></div>
												</div>
												<div class="form-group">
													<label class="form-label">Category</label>
													<input type="text" class="form-control" name="category" id="category" placeholder="Category" autocomplete="off" value="<?php echo $insulininfo->insulin_category; ?>">
												...
												<div class="form-group ">
													...
													<select name="status" id="status" class="form-control">
														...
														<option value="1" <?php if($insulininfo->is_active==1){echo 'selected'; } ?>>Active</option>
														<option value="0" <?php if($insulininfo->is_active==0){echo 'selected'; } ?>>Inactive</option>
																						
													</select>
													<div class="form-status" id="error-status"></div>
												</div>
											</div>
		...
		function form_acction(msg){
			if(msg=='Update Successfully'){									
				var jmpurl='<?php echo base_url('setup/insulin/');?>';
