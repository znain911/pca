...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Insulin – Changing Diabetes Barometer (CDB)</title>
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Insulin</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/addinsulin');?>" ><i class="fe fe-plus mr-1 mt-1"></i> Add New</a>
							</div>
						</div>
						<!-- End page-header -->
								...
								<div class="card-body">
                                	<div class="table-responsive" id="hba1ctable">
										<table id="example" class="table table-striped table-bordered w-100">
											...
											<tbody>
												<?php foreach($insulinlist as $inlist){?>
												<tr>
													<td><?php echo $inlist->insulin_name;?></td>
													<td><?php echo $inlist->insulin_clinical_type;?></td>
													<td><?php echo $inlist->insulin_class;?></td>
													<td><?php echo $inlist->insulin_category;?></td>
													<td>
														<?php if($inlist->is_active==1){
															echo 'Active';
														} else{
															echo 'Inactive';
														}?>
													...
													<td>
														<a href="<?php echo base_url('setup/editinsulin/').$inlist->insulin_id;?>" class="btn btn-app btn-primary btn-sm"><i class="fa fa-edit"></i>Edit</a>
													</td>
												</tr>
												<?php }?>
