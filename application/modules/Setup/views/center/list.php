...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Center – Changing Diabetes Barometer (CDB)</title>
					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<div class="ml-auto">
									...
									<a class="btn btn-success" href="<?php echo site_url('setup/addcenter');?>" ><i class="fe fe-plus mr-1 mt-1"></i> Add New</a>
							</div>
						</div>
						<!-- End page-header -->
								...
								<div class="card-body">
                                	<div class="table-responsive" id="hba1ctable">
										<table id="example" class="table table-striped table-bordered w-100">
											...
											<tbody>
												<?php foreach($centerlist as $list){?>
												<tr>
													...
													<td>
														<a href="<?php echo base_url('setup/editcenter/').$list->center_id;?>" class="btn btn-app btn-primary btn-sm"><i class="fa fa-edit"></i>Edit</a>
													</td>
												</tr>
												<?php }?>
