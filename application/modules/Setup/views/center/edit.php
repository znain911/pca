...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Edit Center - Changing Diabetes Barometer (CDB)</title>
	...
	<body class="app sidebar-mini rtl">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url('setup/center');?>">Center</a></li>
								<li class="breadcrumb-item active" aria-current="page">Edit Center</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/center');?>" ><i class="fe fe-list mr-1 mt-1"></i> Center List</a>
							</div>
						</div>
						<!-- End page-header -->
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Edit Center</h3>
										...
										<div class="row">
											...
											<div class="col">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="inslname" name="inslname" placeholder="Name" autocomplete="off" value="<?php echo $info->center_name; ?>">
													<div class="form-error" id="error-inslname"></div>

												</div>

												<div class="form-group">
													<label class="form-label" for="code">Center Code</label>
													<input type="text" class="form-control" id="code" name="code" placeholder="Code" autocomplete="off" value="<?php echo $info->center_code; ?>">
													<div class="form-error" id="error-code"></div>
												</div>

												<div class="form-group">
													<label class="form-label" for="address">Address</label>
													<input type="text" class="form-control" id="address" name="address" placeholder="Address" autocomplete="off" value="<?php echo $info->address; ?>">
		...
		function form_acction(msg){
			if(msg=='Update Successfully'){									
				var jmpurl='<?php echo site_url('setup/center/');?>';
