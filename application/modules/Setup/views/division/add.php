...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Add Division - Changing Diabetes Barometer (CDB)</title>
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Add new Division</h3>
										...
										<div class="row">
											...
											<div class="col">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="name" name="name" placeholder="Division Name" autocomplete="off">
