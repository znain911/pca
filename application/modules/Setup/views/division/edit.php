...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Edit Division - Changing Diabetes Barometer (CDB)</title>
	...
	<body class="app sidebar-mini rtl">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url('setup/division');?>">Division</a></li>
								<li class="breadcrumb-item active" aria-current="page">Edit Division</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/division');?>" ><i class="fe fe-list mr-1 mt-1"></i> Division List</a>
							</div>
						</div>
						<!-- End page-header -->
										...
										<div class="row">
											...
											<div class="col">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="inslname" name="inslname" placeholder="Name" autocomplete="off" value="<?php echo $info->division_name; ?>">
													<div class="form-error" id="error-inslname"></div>

													<input type="hidden" class="form-control" id="inslnid" name="inslnid" placeholder="Name" autocomplete="off" value="<?php echo $info->division_id; ?>">
												</div>
		...
		function form_acction(msg){
			if(msg=='Update Successfully'){									
				var jmpurl='<?php echo base_url('setup/division/');?>';
