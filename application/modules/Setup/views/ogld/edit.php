...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Edit OGLD - Changing Diabetes Barometer (CDB)</title>
	...
	<body class="app sidebar-mini rtl">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url('setup/ogld');?>">OGLD</a></li>
								<li class="breadcrumb-item active" aria-current="page">Edit OGLD</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/ogld');?>" ><i class="fe fe-list mr-1 mt-1"></i> OGLD List</a>
							</div>
						</div>
						<!-- End page-header -->
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Edit OGLD</h3>
										...
										<div class="row">
											...
											<div class="col">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="inslname" name="inslname" placeholder="Name" autocomplete="off" value="<?php echo $info->brand; ?>">
													<div class="form-error" id="error-inslname"></div>

													<input type="hidden" class="form-control" id="inslnid" name="inslnid" placeholder="Name" autocomplete="off" value="<?php echo $info->id; ?>">
												</div>
												<div class="form-group ">
													<label class="form-label">Generic</label>
													<input type="text" class="form-control" id="type" name="type" placeholder="insulin clinical type" autocomplete="off" value="<?php echo $info->generic; ?>">
													<div class="form-error" id="error-type"></div>
												</div>
												<div class="form-group">
													<label for="phone" class="form-label">strength</label>
													<input type="text" name="strength" id="strength" class="form-control" placeholder="Class" autocomplete="off" value="<?php echo $info->strength; ?>">
													<div class="form-error" id="error-strength"></div>
												</div>
												<div class="form-group">
													<label class="form-label">Dosages</label>
													<input type="text" class="form-control" name="dosages" id="dosages" placeholder="Dosages" autocomplete="off" value="<?php echo $info->dosages; ?>">
													<div class="form-error" id="error-dosages"></div>
												</div>
												<div class="form-group ">
													<label class="form-label">Status</label>
													<select name="status" id="status" class="form-control">
														
														<option value="1" <?php if($info->OGLD==1){echo 'selected'; } ?>>Active</option>
														<option value="0" <?php if($info->OGLD==0){echo 'selected'; } ?>>Inactive</option>
		...
		function form_acction(msg){
			if(msg=='Update Successfully'){									
				var jmpurl='<?php echo base_url('setup/ogld/');?>';
