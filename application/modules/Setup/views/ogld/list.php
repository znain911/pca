					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">OGLD</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/addogld');?>" ><i class="fe fe-plus mr-1 mt-1"></i> Add New</a>
							</div>
						</div>
						<!-- End page-header -->
								...
								<div class="card-body">
                                	<div class="table-responsive" id="hba1ctable">
										<table id="example" class="table table-striped table-bordered w-100">
											...
											<tbody>
												<?php foreach($ogldlist as $list){?>
												<tr>
													<td><?php echo $list->brand;?></td>
													<td><?php echo $list->generic;?></td>
													<td><?php echo $list->strength;?></td>
													<td><?php echo $list->dosages;?></td>
													<td>
														<?php if($list->OGLD==1){
															echo 'Active';
														} else{
													...
													<td>
														<a href="<?php echo base_url('setup/editogld/').$list->id;?>" class="btn btn-app btn-primary btn-sm"><i class="fa fa-edit"></i>Edit</a>
													</td>
												</tr>
												<?php }?>
