...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>OGLD - Changing Diabetes Barometer (CDB)</title>
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add OGLD</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
									<a class="btn btn-success" href="<?php echo base_url('setup/insulin');?>" ><i class="fe fe-list mr-1 mt-1"></i> OGLD List</a>
							</div>
						</div>
						<!-- End page-header -->
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Add new OGLD</h3>
										...
										<div class="row">
											...
											<div class="col">
												...
												<div class="form-group ">
													...
													<input type="text" class="form-control" id="type" name="type" placeholder="Generic" autocomplete="off" value="">
													<div class="form-error" id="error-Select"></div>
												</div>
												<div class="form-group">
													<label for="phone" class="form-label">Strength</label>
													<input type="text" name="strength" id="strength" class="form-control" placeholder="Strength" autocomplete="off">
													<div class="form-error" id="error-strength"></div>
												</div>
												<div class="form-group">
													<label class="form-label">Dosages</label>
													<input type="text" class="form-control" name="dosages" id="dosages" placeholder="Dosages" autocomplete="off">
