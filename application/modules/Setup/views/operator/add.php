...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Add Operators - Changing Diabetes Barometer (CDB)</title>
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url('setup/operator');?>">Operator</a></li>
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Add new Operator</h3>
										...
										<div class="row">
											...
											<div class="col">
												...
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control" id="organization" name="organization" placeholder="Organization" autocomplete="off">
												...
												<div class="form-group col-md-6">
													...
													<select name="role" id="role" class="form-control">
														...
														<option value="<?php echo $glist->id; ?>"><?php echo $glist->description; ?></option>
														<?php }?>					
													</select>
												...
												<div class="form-group col-md-6">
													...
													<select name="center" id="center" class="form-control">
														...
														<option value="<?php echo $clist->center_id; ?>"><?php echo $clist->center_name; ?></option>
														<?php }?>					
													</select>
