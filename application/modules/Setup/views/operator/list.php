...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Operator – Changing Diabetes Barometer (CDB)</title>
					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<div class="ml-auto">
									...
									<a class="btn btn-success" href="<?php echo site_url('setup/addoperator');?>" ><i class="fe fe-plus mr-1 mt-1"></i> Add New</a>
							</div>
						</div>
						<!-- End page-header -->
										...
										<table id="example" class="table table-striped table-bordered w-100">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php if($list->active==1){echo 'Active'; }else{echo 'Inactive';} ?></td>
													<td>
														<a href="<?php echo base_url('setup/editoperator/').$list->id;?>" class="btn btn-app btn-primary btn-sm"><i class="fa fa-edit"></i>Edit</a>
													</td>
												</tr>
												<?php }?>
