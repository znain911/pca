...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>DM Duration – Changing Diabetes Barometer (CDB)</title>
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">DM Duration</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
								
									<a class="btn btn-success" href="<?php echo base_url('setup/adddm_duration');?>" ><i class="fe fe-plus mr-1 mt-1"></i> Add New</a>
							</div>
						</div>
						<!-- End page-header -->
						...
						<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">DM Duration</div>
								</div>
								<div class="card-body">
                                	<div class="table-responsive" id="hba1ctable">
										<table id="example" class="table table-striped table-bordered w-100">
											...
											<tbody>
												<?php foreach($dm_durationlist as $list){?>
												<tr>
													<td><?php echo $list->duration_name;?></td>
													<td><?php if($list->status==1){echo 'Active'; }else{echo 'Inactive';} ?></td>
													<td>
														<a href="<?php echo base_url('setup/editdm_duration/').$list->id;?>" class="btn btn-app btn-primary btn-sm"><i class="fa fa-edit"></i>Edit</a>
													</td>
												</tr>
												<?php }?>
