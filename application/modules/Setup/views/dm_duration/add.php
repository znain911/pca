...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Add dm duration - Changing Diabetes Barometer (CDB)</title>
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add dm duration</li>
							</ol><!-- End breadcrumb -->
							<div class="ml-auto">
									<a class="btn btn-success" href="<?php echo base_url('setup/diabetes_type');?>" ><i class="fe fe-list mr-1 mt-1"></i> DM duration List</a>
							</div>
						</div>
						<!-- End page-header -->
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Add new DM duration</h3>
