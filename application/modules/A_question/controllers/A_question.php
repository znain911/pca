...
class A_question extends Ci_Controller {
	...
	public function addquestion(){
		...
		$data["mdllist"] = $this->a_question_m->get_module();
	...
	public function question_data(){		
		...
		$validation_rules = array(
               	...
               	array('field'   => 'tma', 'label'   => 'Exam Type', 'rules'   => 'trim|xss_clean|required'),
               	array('field'   => 'question_type', 'label'   => 'Question Type', 'rules'   => 'trim|xss_clean|required'),
               	array('field'   => 'anstext[0]', 'label'   => 'Ans', 'rules'   => 'trim|xss_clean|required'),
               );
		...
		if($errors_array)
            echo $errors_array;
				...
				$data = array(
					...
					'qa_module'=>$this->input->post('module'),
