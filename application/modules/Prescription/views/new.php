...
.bootstrap-select.btn-group .dropdown-menu.inner li.active a span{color: #000000 !important;}
</style>
<!--END Style-->
</head>
                        ...
                        <div class="col-lg-12">
                          <div class="col-md-7">
                            <div class="form-horizontal">
                              <div class="col-md-7">
                                <div class="row">
								<div class="col-lg-3" style="text-align: left; "><h5>Member ID:</h5></div>
                                <div class="col-lg-9" style="margin-top: 9px;"> 
                                 
                                  <select class="selectpicker" id="member_id" name="member_id" data-show-subtext="true" data-live-search="true" >
                                    <option value="">--</option>
							  ...
							  <div class="col-md-5">
                                <div class="col-lg-3" style="text-align: right;"><h5>Date</h5></div>
                                <div class="col-lg-9" style="margin-top: 9px;">
                                  <input id="patients_date" name="patients_date" class="form-control" type="text" autocomplete="off">
                                </div>
                              </div>
                              <div class="row" id="mbrdata" style="padding-left:15px;">
                          ...
                          <div class="col-md-5">
                            <div class="form-horizontal">
                              ...
                              <div class="form-group">
                                <label class="control-label col-lg-4" for="designation">Doctor Category</label>
                                <div class="col-lg-8">
                                  <select class="selectpicker form-control" id="designation" name="designation" data-show-subtext="true" data-live-search="true">
                                    <option value="None" selected="selected">None</option>
                                    <?php foreach($doctorcategorylist as $dcatlist){?>
                                    <option value="<?php echo $dcatlist->dcategory_title;?>" ><?php echo $dcatlist->dcategory_title;?></option>
                                    <?php }?>
                                  </select>
                                </div>
                              </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                      	<div class="box">
                                ...
                                <section id="no-more-tables" style="min-height:250px;">
                                  <table id="prescription_histry" class="table table-hover table-striped table-bordered table-advanced tablesorter display" style="">
									<thead>
										<tr>												
									...
									<tbody id="prescription_histry2">
										<tr>												
											<td colspan="3" style="text-align:center;">Select Member</td>												   
                                  ...
                                  <div class="form-group" id="testlistbox">
                                    ...
                                    <div class="col-lg-12">
                                      <div class="input-group">
                                       ...
                                       <button id="createinvstgsn" type="button" class="btn btn-success" style="margin-top: 20px;">Create Investigations</button>

	                                      <div id="invstgsnfrom" class="input-group" style="margin-top: 20px;">
	                                       
	                                        <input type="text" id="item_name" name="item_name" class="form-control">
	                                        <span class="input-group-btn">
	                                         <button id="newtest" class="btn btn-success" type="button">Save & Add to List</button>
	                                         </span> 
	                                     </div>
                                  ...
                                  <div class="form-group" id="symlistbox">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="input-group">
                                        ...
                                        <select class="form-control selectpicker" id="patients_disease_name" name="patients_disease_name" data-live-search="true">
                                           <option value="" selected="selected">Select Chief Complain</option>
                                      ...
                                      <button id="createsymptom" type="button" class="btn btn-warning" style="margin-top: 20px;">Create Chief Complain</button>

                                      <div id="symptomsfrom" class="input-group" style="margin-top: 20px;">
                                       
                                        <input type="text" id="symptmnew" name="symptmnew" class="form-control">
                                        <span class="input-group-btn">
                                         <button id="newsymptm" class="btn btn-info" type="button">Save & Add to List</button>
                                         </span> 
                                     </div>
                                   ...
                                   <div class="col-lg-12">
                                     <form class="form-horizontal">
                                      <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
		                                    <input id="patients_day" name="patients_day" class="form-control" type="text" placeholder="Days">
		                                </div>
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="form-group col-lg-6">
                                    <label class="control-label col-lg-12" for="">Refer To Hospital</label>
                                    <div class="col-lg-12">
                                       <select class="selectpicker form-control" id="hospital_name" name="hospital_name" data-show-subtext="true" data-live-search="true">
											<option value="" selected="selected">--Select--</option>
											<?php foreach($hospitallist as $hlist){?>
...
$(document).ready(function(){
 var sample_data = new Bloodhound({
   ...
   prefetch:'<?php echo base_url(); ?>prescription/autodata_medicine',
   remote:{
    url:'<?php echo base_url(); ?>prescription/autodata_medicine/QUERY%',
    wildcard:'QUERY%'
   }
  });
   ...
   limit:60,
   templates:{
    suggestion:Handlebars.compile('<div class="row"><div class="col-md-6" style="padding-right:5px; padding-left:5px; font-size: 12px;">{{brand_name}}</div><div class="col-md-6" style="padding-right:5px; padding-left:5px; font-size: 12px;">{{generic_name}}</div></div>')
   }
  });
});
...
$(document).ready(function(){
 ...
 $("#invstgsnfrom").hide();
  ...
  $("#createsymptom").click(function(){
    $("#symptomsfrom").show();
  });

  $("#createinvstgsn").click(function(){
    $("#invstgsnfrom").show();
  });


  $("#newsymptm").click(function(){
    var symptoms_name = $('#symptmnew').val();
    var diseaseTrId = 1;
    var dataString = {'symptoms_name': symptoms_name}
        if(symptoms_name != '')
        {
            $.ajax({
                url:"<?php echo base_url(); ?>prescription/AddSymptom",
                method:"POST",
                data:dataString,
                success:function(data)
                {
                    ...
                    var patients_disease_name = symptoms_name;
                    var tr;
		            tr += "<tr id='diseasetr_" + diseaseTrId + "'>";

		            tr += "<td data-title='Disease' id='" + diseaseTrId + 1 + "'>";
					tr += patients_disease_name + "<input type='hidden' name='symtm[]' value='" + patients_disease_name + "' id='symtm[]'>";
		            tr += "</td>";

		            tr += "<td data-title='Action' id='" + diseaseTrId + 2 + "'>";
		            tr += "<div id='" + diseaseTrId + "' class='btn-group disease_delete1'><button class='btn btn-metis-1 btn-sm' data-placement='bottom' data-original-title='Delete Doctor' data-toggle='tooltip'  href='#'><i class='glyphicon glyphicon-trash'></i></button></div>";
		            tr += "</td>";
		            ...
		            $(".disease_delete1").click(function() {
		                var id = $(this).attr("id");
		                var di = $('#diseasetr_' + id).remove();
		            });
                }
            });
  ...
  $("#newtest").click(function(){
    ...
    var testsTrId = 1;
    var dataString = {'item_name': item_name}
        if(item_name != '')
        {
            $.ajax({
                url:"<?php echo base_url(); ?>prescription/AddInvs",
                method:"POST",
                data:dataString,
                success:function(data)
                {
                    ...
                    var patients_tests = item_name;
                    var tr;
		            tr += "<tr id='teststr_" + testsTrId + "'>";

		            tr += "<td data-title='Tests' id='" + testsTrId + 1 + "'>";
		            tr += patients_tests + "<input type='hidden' name='test_name[]' value='" + patients_tests + "' id='test_name[]'>";
		            tr += "</td>";

		            tr += "<td data-title='Action' id='" + testsTrId + 2 + "'>";
		            tr += "<div id='" + testsTrId + "' class='btn-group tests_delete'><button class='btn btn-metis-1 btn-sm' data-placement='bottom' data-original-title='Delete Doctor' data-toggle='tooltip' href='#'><i class='glyphicon glyphicon-trash'></i></button></div>";
		            tr += "</td>";
		            ...
		            $(".tests_delete").click(function() {
		                var id = $(this).attr("id");
		                var di = $('#teststr_' + id).remove();
		            });
                }
            });
  ...
  var employeeTable = $('#employee_data').bootgrid({
   ...
   $(document).on("loaded.rs.jquery.bootgrid", function(){
        ...
        employeeTable.find('.delete').on('click', function(event){
				...
				tr += "<td data-title='Action' id='" + diseaseTrId + 2 + "'>";
				tr += "<div id='" + diseaseTrId + "' class='btn-group disease_delete'><button class='btn btn-metis-1 btn-sm' data-placement='bottom' data-original-title='Delete Disease' data-toggle='tooltip' href='#'><i class='glyphicon glyphicon-trash'></i></button></div>";
				tr += "</td>";
...
$('#member_id').change(function(){
	  ...
	  $("#prescription_histry").show();
	  if(member_id != '')
	  {
	   $.ajax({
		url:"<?php echo base_url(); ?>prescription/get_memberprescription_report",
		method:"POST",
		data:{member_id:member_id},
		success:function(data)
		{
		 $('#prescription_histry2').html(data);		 
		}
	   });
	  }
	  else
	  {
	   $('#prescription_histry2').html('<td colspan="3" style="text-align:center;">Select Member d</td>');
	  }
	 });
