          ...
          <div class="row" style="background: #f5f5f5 none repeat; margin-bottom:20px;">
            <div class="col-md-7">
              <ol class="breadcrumb">
                ...
                <li class="active"> <?php echo $metadata['heading'];?></li>
              </ol>
            ...
            <div class="col-md-5">
              <div style="padding:30px 10px; text-align:right;"> <a class="btn btn-label btn-social btn-github" href="<?php echo base_url($listform);?>"><i class="fa fa-bars"></i><?php echo 'User '.$this->lang->line('List');?></a> </div>
            </div>
          </div>
            ...
            <div data-widget-group="group1">
              ...
              <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                <div class="panel-heading">
                  <h2> <?php echo $metadata['heading'];?></h2>
                </div>
							...
							$form_options = array(
								array(
									'id' => 'Parent_Id',
									  ...
									  'options' => $parants,
									  'class' => '',
									  'value' => isset($Parent_Id) ? $Parent_Id : '',		
								),
							);
              ...
              <?php echo form_close(); ?>
              <?php $this->forminput->formpost('form_usergroup',"loadingdiv",base_url('user/images/loading2.gif'),"submitbtn1","form_acction",$access_save, "Added Successfully" ); ?>
